<template>
	...
	>
		<div ref="contenedor" class="demo-interludio">
				...
				<!-- data-viewbox-v: la caja de la disposición VERTICAL, para teléfono
				     (grupo 355, prompt 05). El viewBox de acá arriba (~1.79:1) en un
				     viewport angosto dejaba la escena entera reducida a una franja
				     minúscula en el medio de la pantalla. No es otra escena: son los
				     mismos nodos con un segundo juego de coordenadas, declarado
				     también en el SVG (data-hv de cada ícono y etiqueta) porque el
				     SVG es el contrato de las posiciones -- misma regla que el
				     prompt 04. El viewBox horizontal se lee del atributo `viewBox`
				     tal como está, así que no hace falta declararlo dos veces. -->
				<svg
					ref="svg"
					xmlns="http://www.w3.org/2000/svg"
					viewBox="-24 -12 1048 586"
					data-viewbox-v="0 0 500 980"
				...
				>
					...
					<g id="escena">
						<g ref="panorama" id="panorama">
							<g id="plano-lejos">
								...
								<g id="etiquetas-orden" font-family="Geist, system-ui, sans-serif" font-size="12" fill="#3A31FC" letter-spacing="0.2">
									<g ref="lblo_1" id="lblo-1" data-h="700,210" data-hv="145,752"><text text-anchor="middle">compra registrada</text></g>
									<g ref="lblo_2" id="lblo-2" data-h="900,210" data-hv="355,752"><text text-anchor="middle">precios actualizados</text></g>
									<g ref="lblo_3" id="lblo-3" data-h="700,342" data-hv="145,852"><text text-anchor="middle">pedidos que entran solos</text></g>
									<g ref="lblo_4" id="lblo-4" data-h="900,342" data-hv="355,852"><text text-anchor="middle">venta facturada</text></g>
									<g ref="lblo_5" id="lblo-5" data-h="700,474" data-hv="145,952"><text text-anchor="middle">cuenta corriente de clientes</text></g>
									<g ref="lblo_6" id="lblo-6" data-h="900,474" data-hv="355,952"><text text-anchor="middle">cuenta corriente de proveedores</text></g>
								</g>
							</g>

							<g id="plano-medio">
								<!-- data-c / data-cv: el centro del portal en cada disposición. Es el
								     punto al que caen los seis del caos y del que salen los seis del
								     orden, así que hasta el grupo 355 (prompt 05) estaba escrito a
								     mano dos veces en aplicar_estilos(). Ahora sale del contrato,
								     como todo lo demás, y la disposición vertical puede tener el
								     suyo sin duplicar código. -->
								<g ref="portal" id="portal" data-open="0.72,0.72" data-c="500,281" data-cv="250,530" transform="translate(500,281)">
							...
							<g id="plano-cerca">
								<g id="zona-caos" fill="none" stroke="#9AA3B5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
									<g ref="caos_1" id="caos-1" data-h="128,96,-12" data-hv="145,90,-12" data-sc="1.9">
										<rect x="-8" y="-1" width="16" height="10" rx="1"></rect>
										<path d="M -8 3 L 8 3"></path>
										<path d="M 0 -11 L 0 -4 M -3 -7 L 0 -4 L 3 -7"></path>
									</g>
									<g ref="caos_2" id="caos-2" data-h="286,112,9" data-hv="355,100,9" data-sc="1.9">
										<path d="M -8 -9 L 3 -9 L 9 -3 L 0 6 L -8 -2 Z"></path>
										<circle cx="-4" cy="-5" r="1.3"></circle>
										<path d="M -9 9 L -4 5.5 L 0 10 L 5 6 L 9 9.5"></path>
									</g>
									<g ref="caos_3" id="caos-3" data-h="108,206,15" data-hv="145,205,15" data-sc="1.9">
										<path d="M -10 -8 L 10 -8 L 10 4 L -2 4 L -6 9 L -6 4 L -10 4 Z"></path>
										<path d="M -6 -4 L 6 -4"></path>
										<path d="M -6 0 L 2 0"></path>
									</g>
									<g ref="caos_4" id="caos-4" data-h="262,222,-8" data-hv="355,215,-8" data-sc="1.9">
										<path d="M -7 -10 L 7 -10 L 7 10 L -7 10 Z"></path>
										<path d="M -4 -4 C -2 -6.5 0 -1.5 2 -4 C 3 -5.2 4 -4.2 4.5 -3.6"></path>
										<path d="M -4 2 C -2 -0.5 0 4.5 2 2 C 3 0.8 4 1.8 4.5 2.4"></path>
									</g>
									<g ref="caos_5" id="caos-5" data-h="140,318,7" data-hv="145,320,7" data-sc="1.9">
										<circle cx="0" cy="-6" r="3.5"></circle>
										<path d="M -7 2 A 7 7 0 0 1 7 2"></path>
										<path d="M -8 8 L -3 6 L 2 10 L 8 7"></path>
									</g>
									<g ref="caos_6" id="caos-6" data-h="288,352,-13" data-hv="355,330,-13" data-sc="1.9">
										<path d="M -9 -4 L 0 -9 L 9 -4"></path>
										<path d="M -7 -1 L 7 -1 L 7 6 L -7 6 Z"></path>
								...
								<g id="etiquetas" font-family="Geist, system-ui, sans-serif" font-size="12" fill="#566078" letter-spacing="0.2">
									<g ref="lbl_1" id="lbl-1" data-h="128,138" data-hv="145,142"><text text-anchor="middle">mercadería que entra</text></g>
									<g ref="lbl_2" id="lbl-2" data-h="286,156" data-hv="355,152"><text text-anchor="middle">precios que cambian</text></g>
									<g ref="lbl_3" id="lbl-3" data-h="108,248" data-hv="145,257"><text text-anchor="middle">pedidos por whatsapp</text></g>
									<g ref="lbl_4" id="lbl-4" data-h="266,266" data-hv="355,267"><text text-anchor="middle">ventas anotadas a mano</text></g>
									<g ref="lbl_5" id="lbl-5" data-h="140,360" data-hv="145,372"><text text-anchor="middle">lo que te deben</text></g>
									<g ref="lbl_6" id="lbl-6" data-h="288,394" data-hv="355,382"><text text-anchor="middle">lo que debés</text></g>
								</g>
							</g>
						</g>
						...
						<!-- data-escala-v: cuánto crece el anillo al cerrarse, en la caja VERTICAL.
						     No puede ser el 1.95 de la horizontal: el círculo fino de r=138 llegaría
						     a 269 unidades desde el centro contra los 250 de media caja y se vería
						     rebanado a los dos lados. Con 1.72 llega a 237,4 (12,6 de aire) y el
						     anillo grueso, a 203, le deja al nombre una semicuerda de 170 contra
						     los 140 que mide su textLength vertical -- el mismo tipo de aire que
						     ESCALA_ARCO_FINAL le da en horizontal. -->
						<g ref="arco_envolvente_pos" id="arco-envolvente" data-escala-v="1.72" transform="translate(500,281)">
...
export default {
	...
	data() {
		return {
			...
			ultimo_progreso: 0,
			/**
			 * 'horizontal' (desktop) o 'vertical' (teléfono) -- grupo 355, prompt 05.
			 * La misma escena y la misma coreografía con dos juegos de coordenadas,
			 * los dos declarados en el SVG.
			 */
			disposicion: 'horizontal',
			/** false hasta que sincronizar_disposicion() aplicó una por primera vez. */
			disposicion_aplicada: false,
			/** Centro del portal en cada disposición, leído de data-c/data-cv de #portal. */
			centros: { horizontal: [500, 281], vertical: [500, 281] },
			/** Las dos cajas del SVG, leídas del atributo viewBox y de data-viewbox-v. */
			viewbox_horizontal: '',
			viewbox_vertical: '',
			/** Desplazamiento vertical del nombre respecto del centro del portal. */
			nombre_offset_y: 0,
			/** Escala final del anillo en vertical, leída de data-escala-v; 0 = usar la horizontal. */
			escala_arco_vertical: 0,
			/** { y, textlength } del nombre en cada disposición, leídos del propio <text>. */
			nombre_horizontal: null,
			nombre_vertical: null,
			/** MediaQueryList del breakpoint de la página; null si no hay matchMedia. */
			consulta_movil: null,
			/** Listener del breakpoint, guardado para poder sacarlo en beforeUnmount. */
			on_cambio_viewport: null,
		}
	},
	...
	mounted() {
		...
		/* Elección de disposición: el MISMO breakpoint que ya usa toda la página
		 * (767.98px), no uno nuevo. Se hace una vez acá y se rehace sola al cruzarlo
		 * -- rotar el teléfono no dispara scroll, así que sin este listener la escena
		 * quedaría con la disposición de la orientación anterior. */
		if (typeof window !== 'undefined' && window.matchMedia) {
			self.consulta_movil = window.matchMedia('(max-width: 767.98px)')
			self.on_cambio_viewport = function () {
				self.sincronizar_disposicion()
			}
			if (self.consulta_movil.addEventListener) {
				self.consulta_movil.addEventListener('change', self.on_cambio_viewport)
			} else {
				self.consulta_movil.addListener(self.on_cambio_viewport)
			}
		}
		self.sincronizar_disposicion()
		 ...
		 * y llega acá por el evento `progreso` -- ver on_progreso(). El único
		 * listener propio es el del breakpoint, de acá arriba. */
	},

	beforeUnmount() {
		if (!this.consulta_movil || !this.on_cambio_viewport) {
			return
		}
		if (this.consulta_movil.removeEventListener) {
			this.consulta_movil.removeEventListener('change', this.on_cambio_viewport)
		} else {
			this.consulta_movil.removeListener(this.on_cambio_viewport)
		}
		this.consulta_movil = null
		this.on_cambio_viewport = null
	},
	...
	methods: {
		...
		on_progreso(p) {
			...
			/* Red de seguridad de la disposición: el evento `change` del breakpoint es
			 * quien la cambia, pero se despacha dentro del ciclo de render del
			 * navegador y hay estados en que ese ciclo no corre (pestaña en segundo
			 * plano mientras se rota el teléfono, por ejemplo). Esto es una comparación
			 * y un return: si nada cambió, no hace nada. Así, cualquier cambio de
			 * viewport que se haya perdido queda corregido en el primer frame de
			 * scroll, en vez de dejar la escena con la disposición de antes. */
			this.sincronizar_disposicion()
		...
		leer_contrato_svg() {
			...
			self.pares = INDICES.map(function (n) {
				...
				/* Segundo juego de coordenadas, el de la disposición vertical (grupo 355,
				 * prompt 05). Si un nodo no lo declara, se queda con el horizontal y avisa:
				 * la escena se ve mal, pero se ve -- y el motivo queda en la consola. */
				const v_caos = self.leer_posicion_vertical(caos, 'caos-' + n, h_caos)
				const v_orden = self.leer_posicion_vertical(orden, 'orden-' + n, h_orden)
				...
				const v_lbl = self.leer_posicion_vertical(lbl, 'lbl-' + n, h_lbl)
				const v_lblo = self.leer_posicion_vertical(lblo, 'lblo-' + n, h_lblo)

				/* Los campos planos (caos_x, lbl_y, …) son los de la disposición ACTIVA:
				 * los escribe aplicar_disposicion() copiándolos de uno de los dos juegos.
				 * aplicar_estilos() sigue leyendo esos campos y no sabe nada de
				 * disposiciones -- la coreografía es la misma, cambian las posiciones. */
				return {
					n: n,
					caos: caos,
					lbl: lbl,
					...
					vertical: {
						caos_x: v_caos[0],
						caos_y: v_caos[1],
						/* La rotación es la misma en las dos: es el gesto de "esto está
						 * torcido", no una posición. Si data-hv no la trae, se hereda. */
						caos_rot: v_caos.length > 2 ? v_caos[2] : h_caos[2] || 0,
						orden_x: v_orden[0],
						orden_y: v_orden[1],
						lbl_x: v_lbl[0],
						lbl_y: v_lbl[1],
			...
			if (self.$refs.svg) {
				/* La caja horizontal es la que ya trae el atributo; la vertical, la que
				 * declara data-viewbox-v. Se leen ACÁ, antes de que aplicar_disposicion()
				 * empiece a pisar el atributo viewBox -- y solo la primera vez, porque a
				 * partir de la segunda el atributo puede ser el de la otra disposición. */
				if (!self.viewbox_horizontal) {
					self.viewbox_horizontal = self.$refs.svg.getAttribute('viewBox')
					self.viewbox_vertical = self.$refs.svg.getAttribute('data-viewbox-v') || self.viewbox_horizontal
				}
			}
			...
			if (self.$refs.portal) {
				...
				const centro_h = self.leer_par_numerico(self.$refs.portal.getAttribute('data-c'), [500, 281])
				self.centros = {
					horizontal: centro_h,
					/* Sin data-cv, el respaldo es el centro geométrico de la caja vertical
					 * -- no el centro horizontal, que en esa caja cae contra el borde. */
					vertical: self.leer_par_numerico(
						self.$refs.portal.getAttribute('data-cv'),
						self.centro_de_viewbox(self.viewbox_vertical, centro_h)
					),
				}
			}

			if (self.$refs.arco_envolvente_pos) {
				const escala_v = Number(self.$refs.arco_envolvente_pos.getAttribute('data-escala-v'))
				self.escala_arco_vertical = isNaN(escala_v) ? 0 : escala_v
			}

			if (self.$refs.nombre_texto) {
				/* Geometría del nombre en cada disposición, toda leída del SVG: en
				 * horizontal, su desplazamiento respecto del centro; en vertical, la
				 * altura y el ancho propios que declara (ver el comentario del <text>). */
				/* Solo la primera vez, por el mismo motivo que el viewBox: a partir de la
				 * segunda, `y` y `textLength` son los que dejó aplicar_disposicion(), y si
				 * la disposición activa fuera la vertical se perdería la geometría
				 * horizontal para siempre -- o sea, se rompería el desktop. */
				if (!self.nombre_horizontal) {
					const nombre_y = Number(self.$refs.nombre_texto.getAttribute('y'))
					self.nombre_offset_y = isNaN(nombre_y) ? 0 : nombre_y - self.centros.horizontal[1]
					self.nombre_horizontal = {
						y: isNaN(nombre_y) ? 0 : nombre_y,
						textlength: self.$refs.nombre_texto.getAttribute('textLength'),
					}
				}
				/* y en null (no en 0) cuando el atributo no está: 0 es una altura válida
				 * y no puede confundirse con "no lo declara". */
				const y_vertical = self.$refs.nombre_texto.getAttribute('data-y-v')
				self.nombre_vertical = {
					y: y_vertical !== null && String(y_vertical).trim() !== '' && !isNaN(Number(y_vertical)) ? Number(y_vertical) : null,
					textlength: self.$refs.nombre_texto.getAttribute('data-textlength-v'),
				}
			}
		},

		/**
		 * Escala final del anillo envolvente para la disposición activa. En horizontal
		 * es la constante de siempre; en vertical, la que declara el propio SVG en
		 * data-escala-v -- la caja es la mitad de ancha y con 1.95 el anillo se salía
		 * por los dos costados.
		 *
		 * @returns {number}
		 */
		escala_arco_final() {
			if (this.disposicion !== 'vertical') {
				return ESCALA_ARCO_FINAL
			}
			return this.escala_arco_vertical || ESCALA_ARCO_FINAL
		},

		/**
		 * Centro geométrico de un viewBox "minx miny ancho alto".
		 *
		 * @param {string} viewbox
		 * @param {Array<number>} respaldo
		 * @returns {Array<number>}
		 */
		centro_de_viewbox(viewbox, respaldo) {
			const partes = String(viewbox || '').trim().split(/[\s,]+/).map(Number)
			if (partes.length < 4 || partes.some(isNaN)) {
				return respaldo
			}
			return [partes[0] + partes[2] / 2, partes[1] + partes[3] / 2]
		},

		/**
		 * Parsea "x,y" a [x, y], con respaldo si viene vacío o mal formado.
		 *
		 * @param {string|null} crudo
		 * @param {Array<number>} respaldo
		 * @returns {Array<number>}
		 */
		leer_par_numerico(crudo, respaldo) {
			if (!crudo) {
				return respaldo
			}
			...
			if (String(partes[0]).trim() === '' || String(partes[1]).trim() === '' || isNaN(x) || isNaN(y)) {
				return respaldo
			}
			return [x, y]
		},
		...
		/**
		 * Posición de un nodo en la disposición VERTICAL, leída de su `data-hv`
		 * (grupo 355, prompt 05). Sin ese atributo el nodo se queda con su posición
		 * horizontal -- que en la caja vertical va a quedar fuera de lugar -- y avisa
		 * por consola, mismo criterio que el fallback de las etiquetas: la escena
		 * puede verse mal, pero nunca en silencio.
		 *
		 * @param {SVGElement|undefined} nodo
		 * @param {string} id Id del nodo, para el aviso.
		 * @param {Array<number>} h Posición horizontal ya parseada, como respaldo.
		 * @returns {Array<number>}
		 */
		leer_posicion_vertical(nodo, id, h) {
			const crudo = nodo ? nodo.getAttribute('data-hv') : null
			if (crudo) {
				const partes = crudo.split(',')
				...
				if (partes.length >= 2 && es_numero(partes[0]) && es_numero(partes[1])) {
					return partes.filter(es_numero).map(Number)
				}
			}

			console.warn(
				'[interludio-portal] ' + id + ' no declara data-hv: en teléfono se queda en su posición ' +
					'horizontal. Las posiciones de la disposición vertical son contrato del SVG, agregalo ahí.'
			)
			return h.slice()
		},

		/**
		 * Copia a los campos planos de cada par el juego de coordenadas de la
		 * disposición activa, y mueve con ellos lo que no es un par: la caja del SVG,
		 * el portal, el anillo envolvente y el nombre. No toca ningún tramo de la
		 * coreografía -- cambian las posiciones, no los tiempos.
		 *
		 * @returns {void}
		 */
		aplicar_disposicion() {
			const self = this
			const vertical = self.disposicion === 'vertical'
			const clave = vertical ? 'vertical' : 'horizontal'
			const centro = self.centros[clave]

			self.pares.forEach(function (par) {
				const juego = par[clave]
				Object.keys(juego).forEach(function (campo) {
					par[campo] = juego[campo]
				})
			})

			if (self.$refs.svg) {
				self.$refs.svg.setAttribute('viewBox', vertical ? self.viewbox_vertical : self.viewbox_horizontal)
				/* La clase la consumen las reglas del <style scoped> de acá abajo, que en
				 * vertical agrandan las etiquetas y retiran el horizonte:
				 * la caja vertical es la mitad de ancha, así que el mismo font-size en
				 * unidades del viewBox se ve más chico en pantalla, no más grande. */
				self.$refs.svg.classList.toggle('demo-portal__svg--vertical', vertical)
			}

			const traslado = 'translate(' + centro[0] + ',' + centro[1] + ')'
			if (self.$refs.portal) {
				self.$refs.portal.setAttribute('transform', traslado)
			}
			if (self.$refs.arco_envolvente_pos) {
				/* Como atributo XML y no por style, igual que lo trae el markup: el
				 * transform de CSS REEMPLAZA al atributo, y acá el hijo ya usa style
				 * para su escala. */
				self.$refs.arco_envolvente_pos.setAttribute('transform', traslado)
			}
			if (self.$refs.nombre_texto) {
				self.$refs.nombre_texto.setAttribute('x', String(centro[0]))

				const geometria = vertical ? self.nombre_vertical : self.nombre_horizontal
				/* En vertical, si el SVG no declara altura propia, se cae al mismo
				 * desplazamiento de la horizontal: la escena se ve, aunque el nombre
				 * quede más abajo de lo ideal. */
				const declara_altura = geometria && typeof geometria.y === 'number' && !isNaN(geometria.y)
				const y = declara_altura ? geometria.y : centro[1] + self.nombre_offset_y
				self.$refs.nombre_texto.setAttribute('y', String(y))
				if (geometria && geometria.textlength) {
					self.$refs.nombre_texto.setAttribute('textLength', geometria.textlength)
				}
			}
		},

		/**
		 * Elige disposición según el ancho de viewport y, si cambió, la aplica y
		 * vuelve a pintar la pose del último progreso conocido -- si no, la escena
		 * quedaría con las coordenadas nuevas pero la pose vieja hasta el próximo
		 * scroll (rotar el teléfono no scrollea).
		 *
		 * @returns {void}
		 */
		sincronizar_disposicion() {
			const nueva = this.consulta_movil && this.consulta_movil.matches ? 'vertical' : 'horizontal'
			if (nueva === this.disposicion && this.disposicion_aplicada) {
				return
			}
			this.disposicion = nueva
			this.disposicion_aplicada = true
			this.aplicar_disposicion()
			this.aplicar_estilos(this.reduced_motion ? 1 : this.ultimo_progreso)
		},
		...
		aplicar_estilos(p) {
			 ...
			 * ya arrancó en 0.26). */
			/* Punto de convergencia: el centro del portal de la disposición activa, tal
			 * como lo declara el SVG (data-c / data-cv). Antes eran dos 500,281 escritos
			 * a mano acá adentro, que en la caja vertical apuntaban a cualquier lado. */
			const centro = self.centros[self.disposicion === 'vertical' ? 'vertical' : 'horizontal']
			const centro_x = centro[0]
			const centro_y = centro[1]
			...
			self.pares.forEach(function (par, i) {
				...
				const x_caos = lerp(par.caos_x, centro_x, avance_caos)
				const y_caos = lerp(par.caos_y, centro_y, avance_caos)
				...
				const x_orden = lerp(centro_x, par.orden_x, avance_orden)
				const y_orden = lerp(centro_y, par.orden_y, avance_orden)
...
/* El horizonte son tres líneas de 900 unidades de largo, dibujadas para la caja ancha:
   en la vertical cruzarían el medio de la pantalla y saldrían cortadas por el borde
   derecho. Y hacen daño además de verse mal -- el escalado de #panorama en el cierre
   (transform-origin: center) se calcula sobre el fill-box del grupo, que con esas
   líneas adentro se estira hasta x=960 y desplaza toda la escena 28px a la derecha
   justo cuando el anillo se cierra sobre ella. Se retiran en vertical: son decorado de
   la disposición ancha, no parte de la narrativa. */
.demo-portal__svg--vertical #horizonte {
	display: none;
}

/* Disposición vertical (grupo 355, prompt 05): la caja pasa de 1048 a 500 unidades de
   ancho, así que en pantalla cada unidad vale MÁS -- pero el texto sigue midiendo 12
   unidades y, a 375px de viewport, eso son ~9px: chico para leer en la mano.

   13 es el techo medido a 375px de viewport, no un número elegido de arriba: con 14,
   las dos etiquetas más largas de la última fila del orden ("cuenta corriente de
   clientes" y "…de proveedores") quedaban a 8px una de otra y a 17px del borde. Con 13
   se ven a ~10px de alto, con 17px de aire entre ellas y 22px contra el borde más
   ajustado. Solo el tamaño: las posiciones son contrato del SVG. */
.demo-portal__svg--vertical #etiquetas,
.demo-portal__svg--vertical #etiquetas-orden {
	font-size: 13px;
}

/* El nombre se angosta a 280 unidades en vertical (data-textlength-v): con el
   font-size de 53.9 y lengthAdjust="spacingAndGlyphs" el navegador comprimiría los
   glifos para llegar a ese ancho y "ComercioCity" quedaría espachurrado. Bajarlo a 44
   es lo que hace que el ancho nuevo sea el natural del texto y no una deformación. */
.demo-portal__svg--vertical #nombre-final text {
	font-size: 44px;
}
